								...
								<tbody> \
									...
									<tr> \
										...
										<td class="at-fb-tb-body" style="border-bottom:0; padding:10px; background:#fff; width:370px;"> \
											<div class="at-fb-footer" style="border-bottom:1px solid #DDDDDD; padding-bottom:5px; margin-bottom:10px; direction:rtl; text-align:right"> \
												<a href="#"> \
													<img src="' + baseURL + 'closelabel.gif" alt="Stäng" class="close" /> \
												</a> \
											</div> \
