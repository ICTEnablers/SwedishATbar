(function(){
    ...
    var plugin = function(){
		...
		AtKit.addLocalisationMap("en", {
			...
			"fonts_sitespecific" : "--Site specific--",
			"fonts_apply": "Apply"
		});

		AtKit.addLocalisationMap("se", {
			"fonts_dialogTitle" : "Typsnittsinställningar",
			"fonts_fontFace" : "Typsnitt",
			"fonts_lineSpacing" : "Radavstånd",
			"fonts_sitespecific" : "--Webbplatsens typsnitt--",
			"fonts_apply": "Ok"
		});
