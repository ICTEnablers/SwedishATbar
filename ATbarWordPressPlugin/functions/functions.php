...
function toolbarlauncher() {
	...
	switch ($version){
		...
		default:
		case "se":
			$js = file_get_contents(dirname(__FILE__).'/atbar-launcher-se.js');
		break;
	...
	$launcher = '<a href="'.$js.'" id="toolbar-launch" title="Starta ATbar för att justera sidan, få sidan uppläst och andra funktioner."><img src="https://core.atbar.se/resources/img/launcher.png" alt="ATbar"></a>';
...
function persistentlaunch() {
	...
	switch ($version){
		...
		default:
		case "se":
			$ptoolbar = file_get_contents(dirname(__FILE__).'/atbar-launcher-se.js');
		break;
...
function shortcode_launcher() {
	...
	$image = '<img src="https://core.atbar.se/resources/img/launcher.png" alt="ATbar">';
	$url = '<a href="'.$js.'" id="toolbar-launch-shortcode" title="Starta ATbar för att justera sidan, få sidan uppläst och andra funktioner.">'.$image.'</a>';
