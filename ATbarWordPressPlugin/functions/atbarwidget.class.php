...
class ATbar_Widget extends WP_Widget{
	...
	private function launcher(){
		...
		$launcher = '<a href="'.$js.'" id="toolbar-launch" title="Starta ATbar för att justera denna sida, eller få den uppläst och andra funktioner."><img src="https://core.atbar.se/resources/img/launcher.png" alt="ATbar"></a>';
